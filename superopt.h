...
#define PERFORM_LDA16F(d, co, r1, r2, ci) \
  ((d) = (r1) + ((r2) << 1), (co) = (ci))
#define PERFORM_LDA16B(d, co, r1, r2, ci) \
  ((d) = (r1) - ((r2) << 1), (co) = (ci))
#define PERFORM_LDAWF(d, co, r1, r2, ci) \
  ((d) = (r1) + ((r2) << 2), (co) = (ci))
#define PERFORM_LDAWB(d, co, r1, r2, ci) \
  ((d) = (r1) - ((r2) << 2), (co) = (ci))
...
#endif
#ifndef PERFORM_MKMSK
#define PERFORM_MKMSK(d, co, r1, ci) \
  ((d) = ((unsigned_word) (r1) > 31) ? 0xffffffff : (1 << (r1)) - 1, (co) = (ci))
#endif
